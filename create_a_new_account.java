...
public class create_a_new_account extends javax.swing.JFrame {
    ...
    private void registerUser (){
        ...
        String query = "INSERT INTO `register table` (`First Name`,`Last Name`,`User Name`,`District`,`Password`,`Mobile Number`,`Email`) VALUES (?,?,?,?,?,?,?)";
        try {
            ...
            Logger.getLogger(create_a_new_account.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnCAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCAActionPerformed
        ...
        String UserNme2=txtUserName.getText();
        
        try {

        ResultSet rs;
        PreparedStatement ps;
        String query = "SELECT * FROM `register table` WHERE `User Name` =?";
        ps = Database_Connector.getConnection().prepareStatement(query);


        
        ps.setString(1, UserNme2);
        rs = ps.executeQuery();
            
        if(rs.next())
            {
                JOptionPane.showMessageDialog(null,"This Username Alredy Exits!");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        login_interface dash;
        dash = new login_interface();
