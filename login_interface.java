...
public class login_interface extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 30, 160, 60));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 320, 132, 30));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/places_ella.jpg"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 350, 600));
        jPanel1.add(txtUserName, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 140, 240, -1));
        ...
        jPanel1.add(passLogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 210, 240, -1));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 270, 200, 30));
    ...
    private boolean cheackEmptyFields(){
        ...
        if(txtUserName.getText().isEmpty() | passLogin.getText().isEmpty()){
    ...
    private void loginUser(){
        ...
        String query = "SELECT * FROM `register table` WHERE `USER NAME` =? AND `PASSWORD` =?";
        ...
        try {
            ...
            if(rs.next())
            {
                ...
                JOptionPane.showMessageDialog(this, "Your User Name or Password Incorrect");
            }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        create_a_new_account create;
        create = new create_a_new_account();
